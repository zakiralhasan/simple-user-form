...
const LoginPage = () => {
  ...
  const loginToUser = () => {
    setLoading(true); // used for going to home page after login issue
    ...
    <div className="bg-gray-300 h-screen pt-16">
      <div className="bg-white w-1/2 mx-auto py-8 rounded shadow-md">
        ...
        <div className="flex flex-col gap-4">
          <input
            onBlur={getUserEmail}
            className="mx-4 outline-none px-3 py-1 rounded"
            type="email"
            name=""
        ...
        <div className="flex px-8 my-4 justify-between">
          ...
          <Link to="/recover" className="text-blue-500">
            Forgot password?
          </Link>
        </div>
        <div className="px-8 py-4">
          <button
            onClick={loginToUser}
            className="bg-blue-400 w-full px-8 py-2 rounded font-semibold text-white"
          >
            Login with email
          </button>
        </div>
